package com.lab411.cpu_frequence;
...
//        try {
//            Process proc = Runtime.getRuntime().exec("/sys/devices/system/cpu/cpu0/cpufreq/cpuinfo_min_freq");
//            InputStream input = proc.getInputStream();
//            StringBuilder builder = new StringBuilder();
//            BufferedReader br = new BufferedReader(new InputStreamReader(input));
//            String line = null;
...
//            br.close();
//
//            currentCPUMinFrequencyTV.setText(builder.toString()+" KHZ");
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
